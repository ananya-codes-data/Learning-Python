...
# .replace is used twice above and that's called chaining, we can chain string functions together

# 3. finding double space in a string
message = "Hi everyone I'm  Ananya Pradhan  "
print(message.find("  "))

# 4. replacing double place in a string
print(message.replace("  ", " "))

# strings are immutable which means that you cannot change them by running functions on them

# 5. formating a string using escape sequence characters
